#!/usr/bin/env node
// Vendored from ui-sound-design by Danny Williams (MIT; licenses/ui-sound-design-LICENSE.txt),
// https://github.com/dannyjpwilliams/ui-sound-design-skill, unmodified below this header.
// Use: describe a reference sound someone supplies ("make it sound like this .wav"),
// then pick the sfx.mjs recipe and words its synthesis_suggestion points to.
