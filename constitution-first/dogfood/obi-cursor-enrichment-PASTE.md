...
**Then:** re-sync Linear [The Manifesto](https://linear.app/off-brand-studio/document/the-manifesto-b2413f5b87dd) from the repo (repo file wins).

Do **not** weaken Creed #6 (accept-gated) or #9 (lovable without Obi) — this line adds philosophical done; it does not replace them.
