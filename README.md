...
| [`agent-worktrees/`](./agent-worktrees) | ✅ v1 → 🚀 pending | 1.0.0 | Packaged for offbr.co — run `docs/PUBLISH-offbr.md` |
| [`constitution-first/`](./constitution-first) | ✅ v1 → 🚀 pending | 1.0.0 | Packaged for offbr.co — run `docs/PUBLISH-offbr.md` |
